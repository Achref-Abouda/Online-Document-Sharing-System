...
Selected Users  <input type="text" id="selectedUsersResult" name="selectedUsersResult" readonly value="public">
           ...
           <div class="def-item">
            <input type="hidden" class="inp-file" name="fname[]" value="<?php echo $v ?>" data-uuid="<?php echo $k ?>">
                  <div id="" class="row mt-2 dz-processing dz-success dz-complete">
                      ...
                      <div class="col-auto d-flex align-items-center">
                        <div class="btn-group">
                        <button class="btn btn-danger delete" id="delete-button" <?php echo isset($file_json) ? 'disabled' : '' ?>>
                            <i class="fas fa-trash"></i>
                            <span>Delete</span>
                          </button>
                        </div>
...
<script>
    $('#default-preview .delete').click(function(){
        var isOldFile = <?php echo isset($file_json) ? 'true' : 'false'; ?>;
        $('#delete-button').prop('disabled', isOldFile);
